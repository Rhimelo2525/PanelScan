import { AlertCircle, ArrowLeft, CalendarDays, CheckCircle2, Loader2, MapPin, Truck } from "lucide-react"
    ...
    <Container className="py-10 sm:py-14 lg:py-18">
      ...
      <div className="mt-10 grid items-start gap-10 lg:grid-cols-[minmax(0,1fr)_22rem] lg:gap-14">
        ...
        <aside className="space-y-5">
          ...
          <section className="surface-card p-6" aria-labelledby="fulfilment-title"><div className="flex items-center gap-2"><Truck className="size-4 text-primary" aria-hidden="true" /><h2 id="fulfilment-title" className="font-semibold">Delivery coordination</h2></div><p className="mt-3 text-sm leading-6 text-muted-foreground">Delivery records are created by PanelScan staff after order placement. The current order response does not include courier or tracking data.</p></section>
        </aside>
      </div>
    </Container>
  )
